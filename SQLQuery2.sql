...
Homeowner text,
Cars integer,
Communtedistance text,
Region text);

Drop table Reg ;

Alter Table reg_info add Occupation text,

Select* from Reg_info;

insert into Reg 
(Names, MartitalStatus, Gender, Income, Children, Education, Occupation, Homeowner, Cars, communtedistance, Region) values
...
Select * From Reg Where Gender = 'F';