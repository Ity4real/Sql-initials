...
Select * From Reg_info Where Gender = 'F';
Select * From Reg_info Where Gender = 'M';
Select * From Reg_info Where Cars= 0;
Select * From Reg_info Where Communtedistance > '1-2 Miles';
Select * From Reg_info Where region = 'Europe';
Select * From Reg_info Where MaritalStatus = 'S';
Select * From Reg_info Where MaritalStatus = 'M';
Select * From Reg_info Where MaritalStatus = 'S';
Select * From Reg_info Where Gender = 'M' AND Education = 'Barchelors' AND Income > 50000;
Select * From Reg_info Where Gender = 'F' AND Education = 'High School' AND Income < 70000;
Select * From Reg_info Where Children = 0;